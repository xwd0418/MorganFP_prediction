...
def get_superclass_and_glycoside(smiles):
    ...
    superclass_results = json_dat['class_results'][0]
...
for split in ['val', 'test', "train"]:
    ...
    os.makedirs(f'/root/MorganFP_prediction/reproduce_previous_works/reproducing_deepsat/{split}/Superclass',exist_ok=True)            
    pickle.dump(superclass_results,open(f'/root/MorganFP_prediction/reproduce_previous_works/reproducing_deepsat/{split}/Superclass/index.pkl','wb'))
