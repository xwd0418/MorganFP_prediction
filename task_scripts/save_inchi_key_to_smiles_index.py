...
for split in ["test", "train", "val"]:
    smiles = pickle.load(open(f'/root/MorganFP_prediction/James_dataset_zips/SMILES_dataset/{split}/SMILES/index.pkl', 'rb'))
...
# %%
f = open('/root/data/NP-MRD-dataset/NP-MRD_metadata/npmrd_natural_products.json')
data = json.load(f)
...
with open("/root/MorganFP_prediction/task_scripts/inchi_mapping.pkl", 'wb') as file:
